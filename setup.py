...
with codecs.open(os.path.join(here, 'versa', '__init__.py'), encoding='utf-8') as f:
...
setup(
    ...
    author_email='devcbezerra@gmail.com',
    classifiers=[
    ...
    dependency_links=[],
    description="versa-framework is a next-gen object-oriented Discord.py bot framework "
                "batteries included, allowing you to write powerful Discord applications easily and quickly.",
    entry_points={
        'console_scripts': [
            'versa=versa.cli:main_cli',
        ],
    },
    ...
    name='versa-framework',
    packages=find_namespace_packages(include=['versa', 'versa.*', 'versa.extensions.essentials'], exclude=['*.migrations']),
    python_requires=python_requirement,
    setup_requires=setup_requirements,
    test_suite='tests',
    tests_require=test_requirements,
    url='https://github.com/BezerraC/versa-framework',
    version=version,
    zip_safe=False,
)
