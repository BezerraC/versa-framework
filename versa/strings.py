...
class Strings:
    ...
    def __init__(self, extension):
        ...
        self.module = importlib.import_module('strings', f'versa.extensions.{extension}')

    def __getattr__(self, item):
        return getattr(self.module, item).format


setup_greeting = """versa-framework - First run configuration

Insert your bot's token, or enter 'cancel' to cancel the setup:"""

not_a_token = "Invalid input. Restart versa-framework and repeat the configuration process."
...
invite_link = "https://discord.gg/Fee6Kptq57"
